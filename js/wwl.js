    ...
    data.forEach(row => {
        ...
        warDiv.innerHTML = `
            <div class="title">
                <div class="team">
                    <p>${row.team1}</p>
                    <img src="https://gbtwcoupon.jisby.com/images/wwl/alliance_logo/${row.team1}.png" alt="">
                </div>
                <div></div>
                <div class="team">
                    <img src="https://gbtwcoupon.jisby.com/images/wwl/alliance_logo/${row.team2}.png" alt="">
                    <p>${row.team2}</p>
                </div>
            </div>
